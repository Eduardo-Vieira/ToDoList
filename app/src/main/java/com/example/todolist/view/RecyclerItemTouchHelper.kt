...
open class RecyclerItemTouchHelper(mContext:Context) : ItemTouchHelper.Callback()
{
    ...
    init {
        ...
        deleteDrawable = ContextCompat.getDrawable(mContext, R.drawable.ic_delete_forever_24dp)
